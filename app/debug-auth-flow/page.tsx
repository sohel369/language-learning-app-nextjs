        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
          ...
          {debugInfo.databaseProfile && (
            <div className="bg-white/5 rounded-lg p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center justify-between p-3 bg-white/10 rounded-lg">
                  <div className="flex items-center space-x-3">
                    {getStatusIcon(debugInfo.databaseProfile?.exists)}
                    <span className="text-white font-medium">Profile Exists</span>
                  </div>
                  <div className={`text-sm ${getStatusColor(debugInfo.databaseProfile?.exists)}`}>
                    {debugInfo.databaseProfile?.exists ? 'Yes' : 'No'}
                  </div>
                </div>

                {debugInfo.databaseProfile?.exists && debugInfo.databaseProfile.data && (
                  <>
                    <div className="flex items-center justify-between p-3 bg-white/10 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <User className="w-5 h-5 text-blue-400" />
                      ...
                      <div className="text-white/70 text-sm">
                        {debugInfo.databaseProfile.data.name || 'Not set'}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-white/10 rounded-lg">
                      <div className="flex items-center space-x-3">
                        <User className="w-5 h-5 text-blue-400" />
                        <span className="text-white font-medium">Base Language</span>
                      </div>
                      <div className="text-white/70 text-sm">
                        {debugInfo.databaseProfile.data.base_language || 'Not set'}
                      </div>
                    </div>
                  </>
                )}
          ...
          <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-6 mt-8">
            ...
            <ol className="text-yellow-300 text-sm space-y-2">
              ...
              <li>2. Verify database profile exists and has correct data</li>
              <li>3. Test signup flow and see where it redirects</li>

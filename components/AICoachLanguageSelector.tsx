      ...
      <div className="w-full max-w-2xl">
          ...
          {languages.map((lang) => (
            ...
            >
              <div className="text-center">
                ...
                <p className="text-white/70 text-sm mb-4">{lang.native}</p>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white/80 text-sm">Interactive conversations</span>
            </div>
            <div className="flex items-center space-x-3">
              <Bot className="w-5 h-5 text-purple-400" />
              <span className="text-white/80 text-sm">Personalized feedback</span>
            </div>
            <div className="flex items-center space-x-3">
              <Globe className="w-5 h-5 text-green-400" />
              <span className="text-white/80 text-sm">Language-specific practice</span>
            </div>
            <div className="flex items-center space-x-3">
        ...
        <div className="text-center">
          <button
            ...
            } text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 flex items-center justify-center space-x-3`}
          >
            <span>Continue to AI Coach</span>
        ...
        <div className="mt-8 p-4 bg-blue-500/20 border border-blue-500/50 rounded-lg">
          <div className="text-blue-400 font-medium text-sm mb-2">💡 Tip:</div>
